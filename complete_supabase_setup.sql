-- VH Autoglass - UI-READY COMPLETE SUPABASE SETUP
-- This script sets up the entire database to match the Client and Admin dashbord requirements.
...
('Windshield Replacement', 'Full mobile replacement with OEM quality glass.', '$299.99'),
('Rock Chip Repair', 'Professional resin injection to stop cracks.', '$45.00');

INSERT INTO public.branches (name, address) VALUES
('VH Hub - Main Office', '7491 49 Ave, Red Deer, AB T4P 1N1, Canada');
